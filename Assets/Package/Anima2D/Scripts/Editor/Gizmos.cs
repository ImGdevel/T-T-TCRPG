					...
					if(Selection.activeTransform != transform)
					{
						   ...
						   (control.bone && !Selection.transforms.Contains(control.bone.transform)))
						{
							...
							if(Tools.current == Tool.Move)
							{
								...
								var fmh_212_74_638542477514973718 = transform.rotation; Vector3 newPosition = Handles.FreeMoveHandle(transform.position, size, Vector3.zero, Handles.RectangleHandleCap);
#else
